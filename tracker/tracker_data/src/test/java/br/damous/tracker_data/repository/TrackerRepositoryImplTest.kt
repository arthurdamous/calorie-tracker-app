...
import br.damous.tracker_data.remote.malformedFoodResponse
import br.damous.tracker_data.remote.validFoodResponse
...
class TrackerRepositoryImplTest {
    ...
    @Test
    fun `Search food, malforme response, returns failure`() = runBlocking {
        mockWebServer.enqueue(
            MockResponse()
